...
// ...
    ...
    private void insertDataToFirebase() {
        ...
        mDatabase.child("users").child(userID).child("Appliances").child("1").setValue(appliance1).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
      ...
      //  DocumentReference documentReference2 = fStore.collection("users").document(userID).collection("Appliances").document("2");
        ...
        mDatabase.child("users").child(userID).child("Appliances").child("2").setValue(appliance2).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
       ...
       // DocumentReference documentReference3 = fStore.collection("users").document(userID).collection("Appliances").document("3");
        ...
        mDatabase.child("users").child(userID).child("Appliances").child("3").setValue(appliance3).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
       ...
       // DocumentReference documentReference4 = fStore.collection("users").document(userID).collection("Appliances").document("4");
        ...
        mDatabase.child("users").child(userID).child("Appliances").child("4").setValue(appliance4).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
       ...
       // DocumentReference documentReference5 = fStore.collection("users").document(userID).collection("Appliances").document("5");
        ...
        mDatabase.child("users").child(userID).child("Appliances").child("5").setValue(appliance5).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
       ...
       // DocumentReference documentReference6 = fStore.collection("users").document(userID).collection("Appliances").document("6");
        ...
        mDatabase.child("users").child(userID).child("Appliances").child("6").setValue(appliance6).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
